--- bin/ps/keyword.c.orig	2015-12-29 06:03:45 UTC
+++ bin/ps/keyword.c
@@ -33,7 +33,7 @@ static char sccsid[] = "@(#)keyword.c	8.
 #endif /* not lint */
 #endif
 #include <sys/cdefs.h>
-__FBSDID("$FreeBSD: releng/10.1/bin/ps/keyword.c 267904 2014-06-26 08:55:06Z pluknet $");
+__FBSDID("$FreeBSD: head/bin/ps/keyword.c 283304 2015-05-22 23:07:55Z marcel $");
